...
import {
  ITeacherState,
  teacherActions,
} from "../store/slices/teacher/teacherSlice";
...
export const useTeacher = () => {
  ...
  const teacherRegister = (values: ITeacher) =>
    dispatch(teacherActions.setTeacher(values));
  const getActivitiesTeacher = (values: number) =>
    dispatch(teacherThunks.getActivitiesTeacher(values));
  return {
    state,
    getTeachers,
    //setTeacher,
